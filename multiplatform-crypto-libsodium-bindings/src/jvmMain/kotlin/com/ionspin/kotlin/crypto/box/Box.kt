...
actual object Box {
     ...
     */
    actual fun openBox(  message: UByteArray,
                         ciphertext: UByteArray,
        nonce: UByteArray,
       ...
       // val message = UByteArray(ciphertext.size - crypto_box_MACBYTES)
        val validationResult = sodiumJna.crypto_box_open(
            message.asByteArray(),
            ciphertext.asByteArray(),
    ...
    actual fun easy(
        ...
        val ciphertext = UByteArray(message.size + crypto_box_MACBYTES)
        val messageBytesPadded: ByteArray =   ByteArray(crypto_box_MACBYTES).plus(message.asByteArray())
