...
expect object Box {
     ...
     */
    fun box(ciphertext : UByteArray,message : UByteArray, nonce : UByteArray, recipientsPublicKey: UByteArray, sendersSecretKey: UByteArray) : UByteArray
     ...
     */
    fun openBox(message: UByteArray,ciphertext : UByteArray, nonce: UByteArray, sendersPublicKey: UByteArray, recipientsSecretKey: UByteArray) : UByteArray
