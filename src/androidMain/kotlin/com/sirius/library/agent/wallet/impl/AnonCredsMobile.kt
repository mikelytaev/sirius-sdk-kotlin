...
class AnonCredsMobile(wallet: Wallet) : AbstractAnonCreds() {
    var wallet: Wallet
    var timeoutSec = 60
    ...
    fun issuerRotateCredentialDefStart(credDefId: String?, config: String?): String? {
        try {
    ...
    fun issuerRotateCredentialDefApply(credDefId: String?) {
        try {
    ...
    fun issuerCreateCredentialOffer(credDefId: String?): JSONObject? {
        try {
            return JSONObject(
    ...
    fun issuerRevokeCredential(blobStorageReaderHandle: Int?, revRegId: String?, credRevocId: String?): String? {
        return null
    }

    fun issuerMergeRevocationRegistryDeltas(revRegDelta: String?, otherRevRegDelta: String?): String? {
        return null
    }

    fun proverCreateMasterSecret(masterSecretName: String?): String? {
        try {
    ...
    fun proverSetCredentialAttrTagPolicy(credDefId: String?, taAttrs: String?, retroactive: Boolean) {}
    fun proverGetCredentialAttrTagPolicy(credDefId: String?): String? {
        return null
    }
    ...
    fun proverGetCredential(credDefId: String?): String? {
        try {
    ...
    fun proverDeleteCredential(credId: String?) {
        try {
    ...
    fun proverGetCredentials(filters: String?): List<String>? {
        try {
            val creds: String =
    ...
    fun proverSearchCredential(query: String?): List<String>? {
        return null
    }

    fun proverGetCredentialsForProofReq(proofRequest: String?): String? {
        try {
    ...
    fun proverSearchCredentialsForProofReq(
    ...
    fun toUnqualified(entity: String?): String? {
        try {
