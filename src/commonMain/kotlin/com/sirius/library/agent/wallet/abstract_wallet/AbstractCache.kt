...
abstract class AbstractCache {
     ...
     * }
     */
    abstract fun getSchema(poolName: String?, submitter_did: String?, id: String?, options: CacheOptions?): String?
    ...
    abstract fun getCredDef(poolName: String?, submitter_did: String?, id: String?, options: CacheOptions?): String?
     ...
     * }
     */
    abstract fun purgeSchemaCache(options: PurgeOptions?)
     ...
     * }
     */
    abstract fun purgeCredDefCache(options: PurgeOptions?)
}
