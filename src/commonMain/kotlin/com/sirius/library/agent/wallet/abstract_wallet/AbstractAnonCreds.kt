...
abstract class AbstractAnonCreds {
     ...
     * }
     */
    abstract fun issuerCreateSchema(
        issuerDid: String?,
        name: String?,
        version: String?,
        attrs: List<String?>?
    ...
    fun issuerCreateSchema(
        ...
        return issuerCreateSchema(issuerDid, name, version, arrayOf(*attrs).toList())
    }
    ...
    abstract fun issuerCreateAndStoreCredentialDef(
        issuerDid: String?,
        schema: Any?,
        tag: String?,
    ...
    /**
     * Overload method [.issuerCreateAndStoreCredentialDef]
     */
    fun issuerCreateAndStoreCredentialDef(issuerDid: String?, schema: Any?, tag: String?): Pair<String?, String?> {
     ...
     */
    abstract fun issuerRotateCredentialDefStart(credDefId: String?, config: String?): String?

    /**
     * Overload method [.issuerRotateCredentialDefStart]
     */
    fun issuerRotateCredentialDefStart(credDefId: String?): String? {
     ...
     * @param credDefId an identifier of created credential definition stored in the wallet
     */
    abstract fun issuerRotateCredentialDefApply(credDefId: String?)
     ...
     * }
    </number></number></public_keys> */
    abstract fun issuerCreateAndStoreRevocReg(
        issuerDid: String?,
        revocDefType: String?,
        tag: String?,
        credDefId: String?,
     ...
     * }
     */
    abstract fun issuerCreateCredentialOffer(credDefId: String?): JSONObject?
    ...
    </credential></see></string> */
    abstract fun issuerCreateCredential(
        credOffer: JSONObject?, credReq: JSONObject?, credValues: JSONObject?, revRegId: String?,
        blobStorageReaderHandle: Int?
    ): Triple<JSONObject, String?, JSONObject?>

    /**
     * Overload method [.issuerCreateCredential]
     */
     ...
     */
    abstract fun issuerRevokeCredential(blobStorageReaderHandle: Int?, revRegId: String?, credRevocId: String?): String?
     ...
     */
    abstract fun issuerMergeRevocationRegistryDeltas(revRegDelta: String?, otherRevRegDelta: String?): String?
    ...
    abstract fun proverCreateMasterSecret(masterSecretName: String?): String?

    /**
     * Overload method [.proverCreateMasterSecret]
     */
    @Throws(DuplicateMasterSecretNameException::class)
    fun proverCreateMasterSecret(): String? {
    ...
    </blinded_ms_correctness_proof></blinded_master_secret></cred_offer_json></cred_def_id> */
    abstract fun proverCreateCredentialReq(
        proverDid: String?,
        credOffer: JSONObject?,
        credDef: JSONObject?,
     ...
     */
    abstract fun proverSetCredentialAttrTagPolicy(credDefId: String?, taAttrs: String?, retroactive: Boolean)
     ...
     */
    abstract fun proverGetCredentialAttrTagPolicy(credDefId: String?): String?
    ...
    </cred_json></rev_reg_def_id></cred_json></cred_def_id></attribute></attribute></attribute></credential></credential></credential></credential></credential></credential></credential></credential> */
    abstract fun proverStoreCredential(
        credId: String?,
    ...
    abstract fun proverGetCredential(credDefId: String?): String?
     ...
     */
    abstract fun proverDeleteCredential(credId: String?)
     ...
     * "cred_rev_id": Optional<string> - identifier of credential in the revocation registry definition
     * }]
    </string></string></prover_search_credentials> */
    abstract fun proverGetCredentials(filters: String?): List<String?>?
    ...
    abstract fun proverSearchCredential(query: String?): List<String?>?
     ...
     * "cred_rev_id": Optional<string> - identifier of credential in the revocation registry definition
     * }
    </string></string></credential_info></integer></credential_2_info></integer></credential_2_info></integer></credential_info></non_revoc_interval></credential_info></attr_referent></int></int></non_revoc_interval></filter_json></non_revoc_interval></filter_json></string></str></non_revoc_interval></predicate_info></predicate_referent></attr_info></attr_referent></prover_search_credentials_for_proof_req> */
    abstract fun proverGetCredentialsForProofReq(proofRequest: String?): String?
    ...
    </item_referent></string></string></non_revoc_interval></credential_info></credential></credential></credential></credential></credential></credential></credential></wql></predicate_referent></wql></attr_referent></int></int></non_revoc_interval></wql></non_revoc_interval></filter_json></string></wql></predicate_referent></wql></attr_referent></str></non_revoc_interval></predicate_info></predicate_referent></attr_info></attr_referent> */
    abstract fun proverSearchCredentialsForProofReq(
        proofRequest: JSONObject?,
        extraQuery: String?,
        limitReferents: Int
    ): JSONObject?
    /**
     * Overload method [.proverSearchCredentialsForProofReq]
     */
    /**
     * Overload method [.proverSearchCredentialsForProofReq]
     */
    @JvmOverloads
    fun proverSearchCredentialsForProofReq(proofRequest: JSONObject?, extraQuery: String? = null): JSONObject? {
     ...
     * Overload method [.proverSearchCredentialsForProofReq]
     */
    fun proverSearchCredentialsForProofReq(proofRequest: JSONObject?, limitReferents: Int): JSONObject? {
     ...
     * }
    </timestamp></rev_reg_id></aggregated_proof></credential_proof></credential_proof></credential_proof></credential></credential></credential></credential></credential></credential></credential></int></int></non_revoc_interval></wql></non_revoc_interval></filter_json></string></rev_state4></rev_state3></rev_state2></rev_state1></credential_def3></credential_def2></credential_def1></schema3></schema3_id></schema2></schema2_id></schema1></schema1_id></number></bool></number></bool></number></str></non_revoc_interval></predicate_info></predicate_referent></attr_info></attr_referent> */
    abstract fun proverCreateProof(
        proofReq: JSONObject?, requestedCredentials: JSONObject?, masterSecretName: String?,
        schemas: JSONObject?, credentialDefs: JSONObject?, revStates: JSONObject?
    ): JSONObject?
    ...
    </rev_reg4></rev_reg3></rev_reg2></rev_reg1></rev_reg_def3></rev_reg_def2></rev_reg_def1></credential_def3></credential_def2></credential_def1></schema3></schema3_id></schema2></schema2_id></schema1></schema1_id></timestamp></rev_reg_id></aggregated_proof></credential_proof></credential_proof></credential_proof></str></non_revoc_interval></predicate_info></predicate_referent></attr_info></attr_referent> */
    abstract fun verifierVerifyProof(
        proofRequest: JSONObject?,
        proof: JSONObject?,
        schemas: JSONObject?,
    ...
    abstract fun createRevocation(
        blobStorageReaderHandle: Int, revRegDef: String?,
        revRegDelta: String?, timestamp: Int, credRevId: String?
    ): String?
    ...
    abstract fun updateRevocationState(
        blobStorageReaderHandle: Int, revState: String?, revRegDef: String?,
        revRegDelta: String?, timestamp: Int, credRevId: String?
    ): String?
     ...
     */
    abstract fun generateNonce(): String?
     ...
     */
    abstract fun toUnqualified(entity: String?): String?
}
